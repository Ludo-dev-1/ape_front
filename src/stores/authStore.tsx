...
export const useAuthStore = create<IAuthState>((set) => ({
    ...
    login: (token: string) => {
        ...
        const isParent = decodedToken.role_id === 2; // Vérifie si l'utilisateur est parent
        const isMemberBureau = decodedToken.role_id === 3; // Vérifie si l'utilisateur est membre du bureau
        const isMembre = decodedToken.role_id === 4; // Vérifie si l'utilisateur est membre
    ...
    logout: () => {
        ...
        localStorage.removeItem("isMemberBureau"); // Supprime le statut membre du bureau
        localStorage.removeItem("isParent"); // Supprime le statut parent
